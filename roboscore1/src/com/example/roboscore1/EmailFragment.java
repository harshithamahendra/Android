...
public class EmailFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        theView = inflater.inflate(R.layout.email_fragment, null);
        ...
        builder.setView(theView)
         ...
         EmailFragmentListener mListener;
         ...
         public void onAttach(Activity activity) {
             ...
             try {
                 ...
                 // the host
                 mListener = (EmailFragmentListener) activity;
             } catch (ClassCastException e) {
                 // The activity doesn't implement the interface, throw exception
                 throw new ClassCastException(activity.toString()
                         + " must implement EmailFragmentListener");
             }
         }
       ...
       public void handleOK() {
         // Note that with DialogFragment, we need to call findViewById
            // differently    
            EditText et1 = (EditText) theView.findViewById(R.id.password3);
            EditText et2 = (EditText) theView.findViewById(R.id.email);

            mListener.onDialogPositiveClick(this, et1.getText().toString(),et2.getText().toString());
        }
}
